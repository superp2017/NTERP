...
func initRoute() {
	...
	JsHttp.WhiteHttp("/getallcustomers", GetAllCustomer)    //获取所有客户
	...
	JsHttp.WhiteHttp("/getallsuppliers", GetAllSupplier)       //获取所有供应商
	...
	JsHttp.WhiteHttp("/getallunits", GetAllUnit)            //获取所有的单位

	JsHttp.WhiteHttp("/getallmaterials", GetAllMaterial)     //获取所有的物料
